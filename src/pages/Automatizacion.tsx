...
const Automatizacion = () => {
  ...
  return (
    <div className="bg-background text-foreground">
      <Helmet>
        <title>{automatizacion.seo.title}</title>
        <meta name="description" content={automatizacion.seo.description} />
        <meta property="og:title" content={automatizacion.seo.title} />
        <meta property="og:description" content={automatizacion.seo.description} />
