  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button onClick={() => navigate("/admin-NM/posts/nuevo")}>+ Nuevo post</Button>
      </div>
                ...
                <TableRow key={p.id}>
                  ...
                  <TableCell className="text-right">
                    <div className="flex gap-2 justify-end">
                      <Button size="sm" variant="outline" onClick={() => navigate(`/admin-NM/posts/editar/${p.id}`)}>Editar</Button>
