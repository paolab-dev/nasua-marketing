...
const AdnNasua = () => {
  ...
  return (
    <div className="bg-background text-foreground">
      <Helmet>
        <title>{adnNasua.seo.title}</title>
        <meta name="description" content={adnNasua.seo.description} />
        <meta property="og:title" content={adnNasua.seo.title} />
        <meta property="og:description" content={adnNasua.seo.description} />
