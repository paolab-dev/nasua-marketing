...
const PautaDigital = () => {
  ...
  return (
    <div className="bg-background text-foreground">
      <Helmet>
        <title>{pautaDigital.seo.title}</title>
        <meta name="description" content={pautaDigital.seo.description} />
        <meta property="og:title" content={pautaDigital.seo.title} />
        <meta property="og:description" content={pautaDigital.seo.description} />
